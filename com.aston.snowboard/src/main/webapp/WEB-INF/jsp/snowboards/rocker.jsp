    ...
    <div>
        <table class="col-lg-9 table table-striped">
            ...
            <c:forEach var="snowboard" items="${snowboardList}">
                <tr>
                    <td>
                        <a href="${snowboard.photo}" onclick="window.open(this.href, 'mywin',
'left=20,top=20,width=300,height=400,toolbar=1,resizable=0'); return false;"><img class="col-lg-1" src="${snowboard.photo}" height="100" width="60"></a>
